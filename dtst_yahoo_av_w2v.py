...
with open('data/yahoo/train.csv', 'r', encoding='utf-8') as f:
...
additional_stop_words = ['does', 'don', 'did', 'think', 'help', 'need', 'just', 'know', 'hi', 'want', 'really',
                         'thanks', 'way', 'good', 'say', 'like', 'use', 'www', 'com', 'http', 'nhttp']
...
## Save Results
###############################################################################
with open('data/yahoo/data_yahoo.txt','wb') as fp:
    pickle.dump(data_w2v, fp)

with open('data/yahoo/data_yahoo_av.txt','wb') as fp:
    pickle.dump(data_w2v_av, fp)
    
with open('data/yahoo/yahoo_target.txt','wb') as fp:
