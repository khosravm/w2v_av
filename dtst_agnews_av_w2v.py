...
with open('data/agnews/train.csv', 'r', encoding='utf-8') as f:
...
###############################################################################
window = 10
model_path = "models/agnews_w2v_window" + str(window) + ".model"
...
## Save Results
###############################################################################
with open('data/agnews/data_agnews.txt','wb') as fp:
    pickle.dump(data_w2v, fp)

with open('data/agnews/data_agnews_av.txt','wb') as fp:
    pickle.dump(data_w2v_av, fp)
    
with open('data/agnews/agnews_target.txt','wb') as fp:
